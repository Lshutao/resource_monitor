...
$.formValidator = 
{
	...
	initConfig : function(controlOptions)
	{
		...
		{
			$("#"+settings.submitButtonID).unbind('click').click(function(){return $.formValidator.bindSubmit(settings);});
		}
	...
	showMessage : function(returnObj)
	{
		...
		if (!isValid)
		{		
			showclass = "onError wish_notification"; //wish_notification 输入错误的图标
		...
		{		
			...
			$.formValidator.setTipState(elem,"onCorrect wish_enable",showmsg); //wish_enable 输入成功的图标
		}
		return showmsg;
	},
